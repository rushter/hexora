...
static SUSPICIOUS_LITERALS: Lazy<Vec<SuspiciousLiteral>> = Lazy::new(|| {
    ...
    let paths = [
        ...
        (".solana/", AuditConfidence::High),
        (".config/solana", AuditConfidence::High),
        (".lightning/", AuditConfidence::High),
        (".electrum/", AuditConfidence::High),
        (".metamask/", AuditConfidence::High),
        (".exodus/", AuditConfidence::Medium),
        (".npmrc", AuditConfidence::Medium),
        (".gitconfig", AuditConfidence::Medium),
        (".pypirc", AuditConfidence::Medium),
        (".git-credentials", AuditConfidence::High),
        (".docker/config.json", AuditConfidence::High),
        (".config/pip/pip.conf", AuditConfidence::High),
    ...
    let browser_path = [
        ...
        ("Network/Cookies", AuditConfidence::High),
        ("logins.json", AuditConfidence::High),
        ("key4.db", AuditConfidence::High),
        (".config/google-chrome", AuditConfidence::High),
        (".config/chromium", AuditConfidence::High),
    ...
    let suspicious_keywords = [
        ...
        ("base64.b64", AuditConfidence::High),
        ...
        ("from subprocess import", AuditConfidence::High),
        ("from socket import", AuditConfidence::High),
        ("from requests import ", AuditConfidence::High),
        ("from urllib import", AuditConfidence::High),
        ("from pty import", AuditConfidence::High),
    ];
    ...
    let mut m = vec![
        ...
        SuspiciousLiteral{
            ...
            description: "Suspicious PowerShell command. Potential exploitation.".to_string(),
            confidence: AuditConfidence::Medium,
            rule: Rule::SuspiciousLiteral,
        },
        SuspiciousLiteral{
        ...
        SuspiciousLiteral{
            pattern:"WScript.Shell".to_string(),
            description: "Suspicious usage of Windows Shell. Potential exploitation.".to_string(),
            confidence: AuditConfidence::Medium,
            rule: Rule::SuspiciousLiteral,
        },
        SuspiciousLiteral{
            pattern:".aws/credentials".to_string(),
            description: "Enumeration of AWS credentials file. Possible data exfiltration.".to_string(),
            confidence: AuditConfidence::Medium,
            rule: Rule::SuspiciousLiteral,
        },
        SuspiciousLiteral{
        ...
        SuspiciousLiteral{
            pattern:"api.telegram.org".to_string(),
            description:"Telegram API URL detected. Possible data exfiltration.".to_string(),
            confidence: AuditConfidence::Low,
            rule: Rule::SuspiciousLiteral,
        },
        SuspiciousLiteral{
            pattern:"serveousercontent.com".to_string(),
            description:"Serveo tunnel domain detected. Possible C2 communication.".to_string(),
            confidence: AuditConfidence::Medium,
            rule: Rule::SuspiciousLiteral,
        },
        SuspiciousLiteral{
            pattern:"serveo.net".to_string(),
            description:"Serveo tunnel domain detected. Possible C2 communication.".to_string(),
            confidence: AuditConfidence::Medium,
            rule: Rule::SuspiciousLiteral,
        },
        SuspiciousLiteral{
            pattern:"localhost.run".to_string(),
            description:"SSH tunnel domain detected. Possible C2 communication.".to_string(),
            confidence: AuditConfidence::Medium,
            rule: Rule::SuspiciousLiteral,
        },
