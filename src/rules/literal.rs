...
static SUSPICIOUS_LITERALS: Lazy<Vec<SuspiciousLiteral>> = Lazy::new(|| {
    ...
    let browser_extensions = [
        (
            "Authenticator",
            encrypt!("bhghoamapcdpbohphigoooaddinpkbai"),
            AuditConfidence::High,
        ),
        (
            "Binance",
            encrypt!("fhbohimaelbohpjbbldcngcnapndodjp"),
            AuditConfidence::High,
        ),
        (
            "Bitapp",
            encrypt!("fihkakfobkmkjojpchpfgcmhfjnmnfpi"),
            AuditConfidence::High,
        ),
        (
            "BoltX",
            encrypt!("aodkkagnadcbobfpggfnjeongemjbjca"),
            AuditConfidence::High,
        ),
        (
            "Coin98",
            encrypt!("aeachknmefphepccionboohckonoeemg"),
            AuditConfidence::High,
        ),
        (
            "Coinbase",
            encrypt!("hnfanknocfeofbddgcijnmhnfnkdnaad"),
            AuditConfidence::High,
        ),
        (
            "Core",
            encrypt!("agoakfejjabomempkjlepdflaleeobhb"),
            AuditConfidence::High,
        ),
        (
            "Crocobit",
            encrypt!("pnlfjmlcjdjgkddecgincndfgegkecke"),
            AuditConfidence::High,
        ),
        (
            "Equal",
            encrypt!("blnieiiffboillknjnepogjhkgnoapac"),
            AuditConfidence::High,
        ),
        (
            "Ever",
            encrypt!("cgeeodpfagjceefieflmdfphplkenlfk"),
            AuditConfidence::High,
        ),
        (
            "ExodusWeb3",
            encrypt!("aholpfdialjgjfhomihkjbmgjidlcdno"),
            AuditConfidence::High,
        ),
        (
            "Fewcha",
            encrypt!("ebfidpplhabeedpnhjnobghokpiioolj"),
            AuditConfidence::High,
        ),
        (
            "Finnie",
            encrypt!("cjmkndjhnagcfbpiemnkdpomccnjblmj"),
            AuditConfidence::High,
        ),
        (
            "Guarda",
            encrypt!("hpglfhgfnhbgpjdenjgmdgoeiappafln"),
            AuditConfidence::High,
        ),
        (
            "Guild",
            encrypt!("nanjmdknhkinifnkgdcggcfnhdaammmj"),
            AuditConfidence::High,
        ),
        (
            "HarmonyOutdated",
            encrypt!("fnnegphlobjdpkhecapkijjdkgcjhkib"),
            AuditConfidence::High,
        ),
        (
            "Iconex",
            encrypt!("flpiciilemghbmfalicajoolhkkenfel"),
            AuditConfidence::High,
        ),
        (
            "Jaxx Liberty",
            encrypt!("cjelfplplebdjjenllpjcblmjkfcffne"),
            AuditConfidence::High,
        ),
        (
            "Kaikas",
            encrypt!("jblndlipeogpafnldhgmapagcccfchpi"),
            AuditConfidence::High,
        ),
        (
            "KardiaChain",
            encrypt!("pdadjkfkgcafgbceimcpbkalnfnepbnk"),
            AuditConfidence::High,
        ),
        (
            "Keplr",
            encrypt!("dmkamcknogkgcdfhhbddcghachkejeap"),
            AuditConfidence::High,
        ),
        (
            "Liquality",
            encrypt!("kpfopkelmapcoipemfendmdcghnegimn"),
            AuditConfidence::High,
        ),
        (
            "MEWCX",
            encrypt!("nlbmnnijcnlegkjjpcfjclmcfggfefdm"),
            AuditConfidence::High,
        ),
        (
            "MaiarDEFI",
            encrypt!("dngmlblcodfobpdpecaadgfbcggfjfnm"),
            AuditConfidence::High,
        ),
        (
            "Martian",
            encrypt!("efbglgofoippbgcjepnhiblaibcnclgk"),
            AuditConfidence::High,
        ),
        (
            "Math",
            encrypt!("afbcbjpbpfadlkmhmclhkeeodmamcflc"),
            AuditConfidence::High,
        ),
        (
            "Metamask",
            encrypt!("nkbihfbeogaeaoehlefnkodbefgpgknn"),
            AuditConfidence::High,
        ),
        (
            "Metamask2",
            encrypt!("ejbalbakoplchlghecdalmeeeajnimhm"),
            AuditConfidence::High,
        ),
        (
            "Mobox",
            encrypt!("fcckkdbjnoikooededlapcalpionmalo"),
            AuditConfidence::High,
        ),
        (
            "Nami",
            encrypt!("lpfcbjknijpeeillifnkikgncikgfhdo"),
            AuditConfidence::High,
        ),
        (
            "Nifty",
            encrypt!("jbdaocneiiinmjbjlgalhcelgbejmnid"),
            AuditConfidence::High,
        ),
        (
            "Oxygen",
            encrypt!("fhilaheimglignddkjgofkcbgekhenbh"),
            AuditConfidence::High,
        ),
        (
            "PaliWallet",
            encrypt!("mgffkfbidihjpoaomajlbgchddlicgpn"),
            AuditConfidence::High,
        ),
        (
            "Petra",
            encrypt!("ejjladinnckdgjemekebdpeokbikhfci"),
            AuditConfidence::High,
        ),
        (
            "Phantom",
            encrypt!("bfnaelmomeimhlpmgjnjophhpkkoljpa"),
            AuditConfidence::High,
        ),
        (
            "Pontem",
            encrypt!("phkbamefinggmakgklpkljjmgibohnba"),
            AuditConfidence::High,
        ),
        (
            "Ronin",
            encrypt!("fnjhmkhhmkbjkkabndcnnogagogbneec"),
            AuditConfidence::High,
        ),
        (
            "Safepal",
            encrypt!("lgmpcpglpngdoalbgeoldeajfclnhafa"),
            AuditConfidence::High,
        ),
        (
            "Saturn",
            encrypt!("nkddgncdjgjfcddamfgcmfnlhccnimig"),
            AuditConfidence::High,
        ),
        (
            "Slope",
            encrypt!("pocmplpaccanhmnllbbkpgfliimjljgo"),
            AuditConfidence::High,
        ),
        (
            "Solfare",
            encrypt!("bhhhlbepdkbapadjdnnojkbgioiodbic"),
            AuditConfidence::High,
        ),
        (
            "Sollet",
            encrypt!("fhmfendgdocmcbmfikdcogofphimnkno"),
            AuditConfidence::High,
        ),
        (
            "Starcoin",
            encrypt!("mfhbebgoclkghebffdldpobeajmbecfk"),
            AuditConfidence::High,
        ),
        (
            "Swash",
            encrypt!("cmndjbecilbocjfkibfbifhngkdmjgog"),
            AuditConfidence::High,
        ),
        (
            "TempleTezos",
            encrypt!("ookjlbkiijinhpmnjffcofjonbfbgaoc"),
            AuditConfidence::High,
        ),
        (
            "TerraStation",
            encrypt!("aiifbnbfobpmeekipheeijimdpnlpgpp"),
            AuditConfidence::High,
        ),
        (
            "Tokenpocket",
            encrypt!("mfgccjchihfkkindfppnaooecgfneiii"),
            AuditConfidence::High,
        ),
        (
            "Ton",
            encrypt!("nphplpgoakhhjchkkhmiggakijnkhfnd"),
            AuditConfidence::High,
        ),
        (
            "Tron",
            encrypt!("ibnejdfjmmkpcnlpebklmnkoeoihofec"),
            AuditConfidence::High,
        ),
        (
            "Trust Wallet",
            encrypt!("egjidjbpglichdcondbcbdnbeeppgdph"),
            AuditConfidence::High,
        ),
        (
            "Wombat",
            encrypt!("amkmjjmmflddogmhpjloimipbofnfjih"),
            AuditConfidence::High,
        ),
        (
            "XDEFI",
            encrypt!("hmeobnfnfcmdkdcmlblgagmfpfboieaf"),
            AuditConfidence::High,
        ),
        (
            "XMR.PT",
            encrypt!("eigblbgjknlfbajkfhopmcojidlgcehm"),
            AuditConfidence::High,
        ),
        (
            "XinPay",
            encrypt!("bocpokimicclpaiekenaeelehdjllofo"),
            AuditConfidence::High,
        ),
        (
            "Yoroi",
            encrypt!("ffnbelfdoeiohenkjibnmadjiehjhajb"),
            AuditConfidence::High,
        ),
        (
            "iWallet",
            encrypt!("kncchdigobghenbbaddojjnnaogfppfj"),
            AuditConfidence::High,
        ),
    ];
